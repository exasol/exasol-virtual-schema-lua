...
return {
    ...
    "FN_PRED_AND", "FN_PRED_BETWEEN", "FN_PRED_EQUAL", "FN_PRED_IN_CONSTLIST", "FN_PRED_IS_JSON", "FN_PRED_IS_NOT_JSON",
    "FN_PRED_IS_NOT_NULL", "FN_PRED_IS_NULL", "FN_PRED_LESS", "FN_PRED_LESSEQUAL", "FN_PRED_LIKE",
    "FN_PRED_LIKE_ESCAPE", "FN_PRED_NOT", "FN_PRED_NOTEQUAL", "FN_PRED_REGEXP_LIKE", "FN_PRED_OR",
    ...
    "FN_AGG_FIRST_VALUE", "FN_AGG_GROUPING", "FN_AGG_GROUPING_ID", "FN_AGG_LAST_VALUE", "FN_AGG_LISTAGG",
    "FN_AGG_LISTAGG_DISTINCT", "FN_AGG_LISTAGG_ON_OVERFLOW_ERROR", "FN_AGG_LISTAGG_ON_OVERFLOW_TRUNCATE",
    "FN_AGG_LISTAGG_ORDER_BY", "FN_AGG_LISTAGG_SEPARATOR", "FN_AGG_MAX", "FN_AGG_MEDIAN", "FN_AGG_MIN", "FN_AGG_MUL",
    "FN_AGG_MUL_DISTINCT", "FN_AGG_SOME", "FN_AGG_ST_INTERSECTION", "FN_AGG_ST_UNION", "FN_AGG_STDDEV",
    "FN_AGG_STDDEV_DISTINCT", "FN_AGG_STDDEV_POP", "FN_AGG_STDDEV_POP_DISTINCT", "FN_AGG_STDDEV_SAMP",
